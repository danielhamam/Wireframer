            ...
            <div id="dimension" className="dimension" style={{width: this.state.width + "px", height: this.state.height + "px"}}>
                <div id="zoomable"> 
                    {wireframe && wireframe.items && wireframe.items.map(item => (
                        <WireframeItem item={item} key={item.id} wireframe={wireframe} isCurrSelection={this.state.isCurrSelection} 
                        setItemProps={this.setItemProps} deleteItem = {this.deleteItem} duplicateItem={this.duplicateItem} zoomIn={this.zoomIn} 
                        zoomOut={this.zoomOut} width={this.state.width} height={this.state.height} setSave={this.setSave} setCurrSelection={this.setCurrSelection}/>
                    ))}
                </div>
            </div>
        </div>
